...
try {
    ...
    $PortalBaseUrl   = 'https://spinchange.github.io/aphelion'
    $RepoBaseUrl     = 'https://github.com/spinchange/aphelion'
    ...
    function New-LlmsTxtContent {
        ...
        $lines.Add('# aphelion')
        $lines.Add('')
        $lines.Add('> A YANP-compliant knowledge vault for space science, astronomy, and cosmology.')
        $lines.Add('')
        ...
        $lines.Add('')
        $lines.Add('Aphelion is a satellite knowledge corpus orbiting the Vulture Nest AI/software vault. It compiles space science sources into YANP permanent notes with full provenance. Ingestion uses a shared Firecrawl + Supabase/pgvector pipeline.')
        $lines.Add('')
